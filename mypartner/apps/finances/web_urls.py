...
urlpatterns = [
    ...
    path('finances/shared/liquidar/', web_views.liquidar_view, name='finances-liquidar'),
    ...
    # Tarjetas
    path('finances/tarjetas/', web_views.tarjetas_view, name='finances-tarjetas'),
    path('finances/tarjetas/<uuid:tarjeta_id>/', web_views.tarjeta_detail_view, name='finances-tarjeta-detail'),
    # Ahorros
